...
#
# Last update: Fri Aug  9 15:15:14 2019
...
misc.update(
    {
        "NSEdgeInsets": objc.createStructType(
            "NSEdgeInsets",
            sel32or64(b"{NSEdgeInsets=ffff}", b"{NSEdgeInsets=dddd}"),
            ["top", "left", "bottom", "right"],
        ),
        "NSHashEnumerator": objc.createStructType(
            "NSHashEnumerator",
            sel32or64(b"{_NSHashEnumerator=II^v}", b"{_NSHashEnumerator=QQ^v}"),
            ["_pi", "_si", "_bs"],
        ),
        "NSAffineTransformStruct": objc.createStructType(
            "NSAffineTransformStruct",
            sel32or64(
                b"{_NSAffineTransformStruct=ffffff}", b"{_NSAffineTransformStruct=dddddd}"
            ),
            ["m11", "m12", "m21", "m22", "tX", "tY"],
        ),
        "NSRect": objc.createStructType(
            "NSRect",
            sel32or64(
        ...
        "NSOperatingSystemVersion": objc.createStructType(
            ...
            sel32or64(
                b"{_NSOperatingSystemVersion=iii}", b"{_NSOperatingSystemVersion=qqq}"
            ),
            ["majorVersion", "minorVersion", "patchVersion"],
        ),
        "NSZone": objc.createStructType("NSZone", b"{_NSZone=}", []),
        "NSDecimal": objc.createStructType(
            "NSDecimal",
            b"{_NSDecimal=b8b4b1b1b18[8S]}",
            [
                "_exponent",
                "_length",
                "_isNegative",
...
misc.update(
    {
        ...
        "NSTimeIntervalSince1970": 978_307_200.0,
...
functions = {
    ...
    "NSDecimalDivide": (
        sel32or64(
            b"I^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}I",
            b"Q^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}Q",
        ),
        "",
        {
            "arguments": {
    ...
    "NSEndMapTableEnumeration": (
        sel32or64(b"v^{_NSMapEnumerator=II^v}", b"v^{_NSMapEnumerator=QQ^v}"),
    ),
    "NSEqualRects": (
        sel32or64(
            b"Z{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"Z{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "NSIntegralRect": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "NSEqualSizes": (
        sel32or64(b"Z{_NSSize=ff}{_NSSize=ff}", b"Z{CGSize=dd}{CGSize=dd}"),
    ),
    "NSSwapHostLongToLittle": (sel32or64(b"LL", b"QQ"),),
    "NSSwapLittleDoubleToHost": (b"d{_NSSwappedDouble=Q}",),
    "NSSizeFromCGSize": (
        sel32or64(b"{_NSSize=ff}{CGSize=ff}", b"{CGSize=dd}{CGSize=dd}"),
    ),
    "NSDecimalCompact": (
        b"v^{_NSDecimal=b8b4b1b1b18[8S]}",
        "",
        {"arguments": {0: {"type_modifier": "N"}}},
    ),
    "NSCreateHashTable": (
        sel32or64(
            b"@{_NSHashTableCallBacks=^?^?^?^?^?}I",
            b"@{_NSHashTableCallBacks=^?^?^?^?^?}Q",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "NSOpenStepRootDirectory": (b"@",),
    "NSRoundDownToMultipleOfPageSize": (sel32or64(b"II", b"QQ"),),
    "NSMapInsertIfAbsent": (b"^v@^v^v",),
    "NSLocationInRange": (sel32or64(b"ZI{_NSRange=II}", b"ZQ{_NSRange=QQ}"),),
    "NSFileTypeForHFSTypeCode": (sel32or64(b"@L", b"@I"),),
    "NSEqualRanges": (
        sel32or64(b"Z{_NSRange=II}{_NSRange=II}", b"Z{_NSRange=QQ}{_NSRange=QQ}"),
    ),
    "NSDecimalNormalize": (
        sel32or64(
            b"I^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}I",
            b"Q^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}Q",
        ),
        "",
        {"arguments": {0: {"type_modifier": "o"}, 1: {"type_modifier": "n"}}},
    ),
    "NSFreeHashTable": (b"v@",),
    "NSHostByteOrder": (sel32or64(b"l", b"q"),),
    ...
    "NSPointFromString": (sel32or64(b"{_NSPoint=ff}@", b"{CGPoint=dd}@"),),
    "NSEnumerateMapTable": (
        sel32or64(b"{_NSMapEnumerator=II^v}@", b"{_NSMapEnumerator=QQ^v}@"),
    ),
    "NSIsEmptyRect": (
        sel32or64(
            b"Z{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"Z{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "NSHeight": (
        sel32or64(
            b"f{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "NSHomeDirectory": (b"@",),
    "NSResetMapTable": (b"v@",),
    ...
    "NSDecimalPower": (
        sel32or64(
            b"I^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}II",
            b"Q^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}QQ",
        ),
        "",
        {"arguments": {0: {"type_modifier": "o"}, 1: {"type_modifier": "n"}}},
    ),
    "NSMaxRange": (sel32or64(b"I{_NSRange=II}", b"Q{_NSRange=QQ}"),),
    "NSMinX": (
        sel32or64(
            b"f{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "NSLogPageSize": (sel32or64(b"I", b"Q"),),
    "NSMouseInRect": (
        sel32or64(
            b"Z{_NSPoint=ff}{_NSRect={_NSPoint=ff}{_NSSize=ff}}Z",
            b"Z{CGPoint=dd}{CGRect={CGPoint=dd}{CGSize=dd}}Z",
        ),
    ),
    "NSDecimalCompare": (
        sel32or64(
            b"i^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}",
            b"q^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}",
        ),
        "",
    ...
    "NSPointInRect": (
        sel32or64(
            b"Z{_NSPoint=ff}{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"Z{CGPoint=dd}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "NSSetZoneName": (b"v^{_NSZone=}@",),
    "CFBridgingRetain": (b"@@",),
    "NSCopyObject": (
        sel32or64(b"@@I^{_NSZone=}", b"@@Q^{_NSZone=}"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "NSMidY": (
    ...
    "NSSwapBigLongToHost": (sel32or64(b"LL", b"QQ"),),
    "NSDecimalMultiply": (
        sel32or64(
            b"I^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}I",
            b"Q^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}Q",
    ...
    "NSStringFromRange": (sel32or64(b"@{_NSRange=II}", b"@{_NSRange=QQ}"),),
    "NSHashGet": (b"^v@^v",),
    "NSStringFromClass": (b"@#",),
    "NSPointToCGPoint": (
        sel32or64(b"{CGPoint=ff}{_NSPoint=ff}", b"{CGPoint=dd}{CGPoint=dd}"),
    ),
    "NSUnionRect": (
        sel32or64(
    ...
    "NSRectToCGRect": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    ...
    "NSStringFromPoint": (sel32or64(b"@{_NSPoint=ff}", b"@{CGPoint=dd}"),),
    "NSWidth": (
        sel32or64(
            b"f{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "NSRealMemoryAvailable": (sel32or64(b"I", b"Q"),),
    "NSNextMapEnumeratorPair": (
        sel32or64(b"Z^{_NSMapEnumerator=II^v}^^v^^v", b"Z^{_NSMapEnumerator=QQ^v}^^v^^v"),
    ),
    "NSAllHashTableObjects": (b"@@",),
    "NSPointFromCGPoint": (
        sel32or64(b"{_NSPoint=ff}{CGPoint=ff}", b"{CGPoint=dd}{CGPoint=dd}"),
    ),
    "NSSizeToCGSize": (sel32or64(b"{CGSize=ff}{_NSSize=ff}", b"{CGSize=dd}{CGSize=dd}"),),
    "NSHashInsertKnownAbsent": (b"v@^v",),
    "NSNextHashEnumeratorItem": (
        sel32or64(b"^v^{_NSHashEnumerator=II^v}", b"^v^{_NSHashEnumerator=QQ^v}"),
    ),
    "NSSwapHostLongLongToLittle": (b"QQ",),
    "NSClassFromString": (b"#@",),
    "NSSwapLittleLongToHost": (sel32or64(b"LL", b"QQ"),),
    "NSMakePoint": (sel32or64(b"{_NSPoint=ff}ff", b"{CGPoint=dd}dd"),),
    "NSSizeFromString": (sel32or64(b"{_NSSize=ff}@", b"{CGSize=dd}@"),),
    ...
    "NSEdgeInsetsMake": (
        sel32or64(b"{NSEdgeInsets=ffff}ffff", b"{NSEdgeInsets=dddd}dddd"),
    ),
    "NSIntersectionRect": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
    ...
    "NSCreateHashTableWithZone": (
        sel32or64(
            b"@{_NSHashTableCallBacks=^?^?^?^?^?}I^{_NSZone=}",
            b"@{_NSHashTableCallBacks=^?^?^?^?^?}Q^{_NSZone=}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "NSSwapFloat": (b"{_NSSwappedFloat=I}{_NSSwappedFloat=I}",),
    "NSDecimalSubtract": (
        sel32or64(
            b"I^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}I",
            b"Q^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}Q",
    ...
    "NSSwapLong": (sel32or64(b"LL", b"QQ"),),
    "NSSwapHostLongLongToBig": (b"QQ",),
    "NSResetHashTable": (b"v@",),
    "NSStringFromRect": (
        sel32or64(
            b"@{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"@{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "NSSwapLittleLongLongToHost": (b"QQ",),
    "NSSwapLittleFloatToHost": (b"f{_NSSwappedFloat=I}",),
    "NSOffsetRect": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}ff",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}dd",
        ),
    ),
    "NSCountMapTable": (sel32or64(b"I@", b"Q@"),),
    "NSHFSTypeOfFile": (b"@@",),
    "NSHashInsertIfAbsent": (b"^v@^v",),
    "NSSwapBigIntToHost": (b"II",),
    "NSRecycleZone": (b"v^{_NSZone=}",),
    "NSStringFromProtocol": (b"@@",),
    "NSFrameAddress": (sel32or64(b"^vI", b"^vQ"),),
    "NSCountFrames": (sel32or64(b"I", b"Q"),),
    "CFBridgingRelease": (b"@@",),
    "NSMapMember": (b"Z@^v^^v^^v",),
    "NSDivideRect": (
        sel32or64(
            b"v{_NSRect={_NSPoint=ff}{_NSSize=ff}}^{_NSRect={_NSPoint=ff}{_NSSize=ff}}^{_NSRect={_NSPoint=ff}{_NSSize=ff}}fI",
    ...
    "NSRangeFromString": (sel32or64(b"{_NSRange=II}@", b"{_NSRange=QQ}@"),),
    "NSMapGet": (b"^v@^v",),
    "NSHashInsert": (b"v@^v",),
    ...
    "NSDecimalMultiplyByPowerOf10": (
        sel32or64(
            b"I^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}sI",
    ...
    "NSMakeRect": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}ffff",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}dddd",
        ),
    ),
    "NSMakeCollectable": (b"@@",),
    "NSGetSizeAndAlignment": (
        sel32or64(b"^c^c^I^I", b"^c^c^Q^Q"),
        "",
        {
    ...
    "NSDecimalRound": (
        sel32or64(
            b"v^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}iI",
            b"v^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}qQ",
        ),
        "",
        {"arguments": {0: {"type_modifier": "o"}, 1: {"type_modifier": "n"}}},
    ),
    ...
    "NSAllocateObject": (sel32or64(b"@#I^{_NSZone=}", b"@#Q^{_NSZone=}"),),
    "NSSwapInt": (b"II",),
    "NSUnionRange": (
        sel32or64(
            b"{_NSRange=II}{_NSRange=II}{_NSRange=II}",
            b"{_NSRange=QQ}{_NSRange=QQ}{_NSRange=QQ}",
        ),
    ),
    "NSSelectorFromString": (b":@",),
    "NSStringFromHashTable": (b"@@",),
    "NSHFSTypeCodeFromFileType": (sel32or64(b"L@", b"I@"),),
    "NSSwapDouble": (b"{_NSSwappedDouble=Q}{_NSSwappedDouble=Q}",),
    "NSLog": (b"v@", "", {"arguments": {0: {"printf_format": True}}, "variadic": True}),
    "NSMakeSize": (sel32or64(b"{_NSSize=ff}ff", b"{CGSize=dd}dd"),),
    "NSSwapHostDoubleToLittle": (b"{_NSSwappedDouble=Q}d",),
    "NSRectFromString": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}@", b"{CGRect={CGPoint=dd}{CGSize=dd}}@"
        ),
    ...
    "NSCreateZone": (
        sel32or64(b"^{_NSZone=}IIZ", b"^{_NSZone=}QQZ"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "NSAllMapTableKeys": (b"@@",),
    ...
    "NSDecimalCopy": (
        b"v^{_NSDecimal=b8b4b1b1b18[8S]}^{_NSDecimal=b8b4b1b1b18[8S]}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {0: {"type_modifier": "o"}, 1: {"type_modifier": "n"}},
    ...
    "NSMakeRange": (sel32or64(b"{_NSRange=II}II", b"{_NSRange=QQ}QQ"),),
    "NSConvertSwappedFloatToHost": (b"f{_NSSwappedFloat=I}",),
    "NSContainsRect": (
        sel32or64(
            b"Z{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"Z{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}",
    ...
    "NSSwapBigDoubleToHost": (b"d{_NSSwappedDouble=Q}",),
    "NSIntersectionRange": (
        sel32or64(
            b"{_NSRange=II}{_NSRange=II}{_NSRange=II}",
            b"{_NSRange=QQ}{_NSRange=QQ}{_NSRange=QQ}",
    ...
    "NSSwapHostDoubleToBig": (b"{_NSSwappedDouble=Q}d",),
    "NSRoundUpToMultipleOfPageSize": (sel32or64(b"II", b"QQ"),),
    "NSConvertHostDoubleToSwapped": (b"{_NSSwappedDouble=Q}d",),
    "NSSwapHostLongToBig": (sel32or64(b"LL", b"QQ"),),
    "NSMaxY": (
        sel32or64(
            b"f{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ...
    "NSCreateMapTableWithZone": (
        sel32or64(
            b"@{_NSMapTableKeyCallBacks=^?^?^?^?^?^v}{_NSMapTableValueCallBacks=^?^?^?}I^{_NSZone=}",
            b"@{_NSMapTableKeyCallBacks=^?^?^?^?^?^v}{_NSMapTableValueCallBacks=^?^?^?}Q^{_NSZone=}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "NSExtraRefCount": (sel32or64(b"I@", b"Q@"),),
    "NSRectFromCGRect": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "NSIntegralRectWithOptions": (
        sel32or64(
            b"{_NSRect={_NSPoint=ff}{_NSSize=ff}}{_NSRect={_NSPoint=ff}{_NSSize=ff}}Q",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}Q",
        ),
    ),
    "NSStringFromSize": (sel32or64(b"@{_NSSize=ff}", b"@{CGSize=dd}"),),
    "NSHomeDirectoryForUser": (b"@@",),
    "NSIsFreedObject": (b"Z@",),
    "NSSwapBigFloatToHost": (b"f{_NSSwappedFloat=I}",),
    "NSConvertSwappedDoubleToHost": (b"d{_NSSwappedDouble=Q}",),
    "NSMidX": (
        sel32or64(
            b"f{_NSRect={_NSPoint=ff}{_NSSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "NSReturnAddress": (sel32or64(b"^vI", b"^vQ"),),
    "NSEqualPoints": (
        sel32or64(b"Z{_NSPoint=ff}{_NSPoint=ff}", b"Z{CGPoint=dd}{CGPoint=dd}"),
    ),
    "NSCompareMapTables": (b"Z@@",),
    "NSHashRemove": (b"v@^v",),
    "NSSwapLittleIntToHost": (b"II",),
    "NSCountHashTable": (sel32or64(b"I@", b"Q@"),),
    "NSMapInsertKnownAbsent": (b"v@^v^v",),
    "NSCreateMapTable": (
        sel32or64(
            b"@{_NSMapTableKeyCallBacks=^?^?^?^?^?^v}{_NSMapTableValueCallBacks=^?^?^?}I",
            b"@{_NSMapTableKeyCallBacks=^?^?^?^?^?^v}{_NSMapTableValueCallBacks=^?^?^?}Q",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "NSSwapHostFloatToLittle": (b"{_NSSwappedFloat=I}f",),
    "NSEdgeInsetsEqual": (
        sel32or64(
            b"Z{NSEdgeInsets=ffff}{NSEdgeInsets=ffff}",
            b"Z{NSEdgeInsets=dddd}{NSEdgeInsets=dddd}",
        ),
    ),
    ...
    "NSSearchPathForDirectoriesInDomains": (sel32or64(b"@IIZ", b"@QQZ"),),
}
aliases = {
...
try:
    r(
        ...
        b"setTransformStruct:",
        {
            "arguments": {
                2: {
                    "type": sel32or64(
                        b"{_NSAffineTransformStruct=ffffff}",
                        b"{_NSAffineTransformStruct=dddddd}",
                    )
                }
            }
        },
    ...
    r(
        ...
        b"transformPoint:",
        {
            "retval": {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")},
            "arguments": {2: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")}},
        },
    )
    r(
        b"NSAffineTransform",
        b"transformSize:",
        {
            ...
            "arguments": {2: {"type": sel32or64(b"{_NSSize=ff}", b"{CGSize=dd}")}},
        },
    )
    r(
        b"NSAffineTransform",
    ...
    r(
        ...
        {"arguments": {3: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")}}},
    )
    r(
        b"NSArray",
    ...
    r(
        b"NSArray",
        b"subarrayWithRange:",
        {"arguments": {2: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")}}},
    )
    r(
        b"NSArray",
    ...
    r(
        ...
        b"attribute:atIndex:longestEffectiveRange:inRange:",
        {
            "arguments": {
                4: {"type_modifier": b"o"},
                5: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
            }
        },
    )
    r(
    ...
    r(
        ...
        b"attributesAtIndex:longestEffectiveRange:inRange:",
        {
            "arguments": {
                3: {"type_modifier": b"o"},
                4: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
            }
        },
    )
    r(
    ...
    r(b"NSAutoreleasePool", b"enableFreedObjectCheck:", {"arguments": {2: {"type": "Z"}}})
    ...
    r(b"NSByteCountFormatter", b"allowsNonnumericFormatting", {"retval": {"type": b"Z"}})
    ...
    r(b"NSCalendar", b"isDate:equalToDate:toUnitGranularity:", {"retval": {"type": b"Z"}})
    ...
    r(
        b"NSCalendar",
        b"maximumRangeOfUnit:",
        {"retval": {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")}},
    )
    r(
        b"NSCalendar",
        b"minimumRangeOfUnit:",
        {"retval": {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")}},
    )
    r(
        b"NSCalendar",
    ...
    r(
        ...
        {
            "arguments": {
                2: {"c_array_delimited_by_null": True, "type": "r*"},
    ...
    r(b"NSDateComponentsFormatter", b"allowsFractionalUnits", {"retval": {"type": b"Z"}})
    ...
    r(
        ...
        b"getObjectValue:forString:range:error:",
        {
            ...
            "arguments": {
                2: {"type_modifier": b"o"},
                4: {
                    "type": sel32or64(b"^{_NSRange=II}", b"^{_NSRange=QQ}"),
                    "type_modifier": b"N",
                },
                5: {"type_modifier": b"o"},
            },
    ...
    r(
        b"NSDecimalNumber",
        b"decimalValue",
        {"retval": {"type": b"{_NSDecimal=b8b4b1b1b18[8S]}"}},
    )
    r(
        b"NSDecimalNumber",
        b"initWithDecimal:",
    ...
    r(
        ...
        {
            "arguments": {4: {"type": sel32or64(b"*", b"[1{?=II^v^v}]")}},
    ...
    r(b"NSFileHandle", b"closeAndReturnError:", {"retval": {"type": b"Z"}})
    r(
        b"NSFileHandle",
    ...
    r(b"NSFileHandle", b"getOffset:error:", {"retval": {"type": b"Z"}})
    r(
        b"NSFileHandle",
    ...
    r(b"NSFileHandle", b"seekToEndReturningOffset:error:", {"retval": {"type": b"Z"}})
    r(b"NSFileHandle", b"seekToOffset:error:", {"retval": {"type": b"Z"}})
    r(
        b"NSFileHandle",
    ...
    r(b"NSFileHandle", b"synchronizeAndReturnError:", {"retval": {"type": b"Z"}})
    r(b"NSFileHandle", b"truncateAtOffset:error:", {"retval": {"type": b"Z"}})
    r(b"NSFileHandle", b"writeData:error:", {"retval": {"type": b"Z"}})
    r(
        b"NSFileHandle",
            ...
            "arguments": {
                ...
                4: {
                    "callable": {
                        ...
                        "arguments": {
                            0: {"type": b"^v"},
                            1: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
                            2: {"type": b"^Z", "type_modifier": "o"},
                        },
                    }
                },
    ...
    r(
        ...
        b"getBuffer:length:",
        {
            ...
            "arguments": {
                ...
                3: {"type": sel32or64(b"^I", b"^Q"), "type_modifier": b"o"},
            },
    ...
    r(b"NSKeyedArchiver", b"setRequiresSecureCoding:", {"arguments": {2: {"type": b"Z"}}})
    ...
    r(b"NSLengthFormatter", b"setForPersonHeightUse:", {"arguments": {2: {"type": b"Z"}}})
    r(
    ...
    r(
        ...
        {"arguments": {4: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")}}},
    )
    r(
        b"NSMutableAttributedString",
    ...
    r(
        ...
        {"arguments": {5: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")}}},
    )
    ...
    r(b"NSMutableURLRequest", b"allowsExpensiveNetworkAccess", {"retval": {"type": b"Z"}})
    r(
        b"NSMutableURLRequest",
    ...
    r(b"NSObject", b"accessInstanceVariablesDirectly", {"retval": {"type": "Z"}})
    r(
        b"NSObject",
    ...
    r(
        ...
        b"countByEnumeratingWithState:objects:count:",
        {
            ...
            "retval": {"type": sel32or64(b"I", b"Q")},
            "arguments": {
                2: {"type": sel32or64(b"^{?=L^@^L[5L]}", b"^{?=Q^@^Q[5Q]}")},
                3: {"type": "^@"},
                4: {"type": sel32or64(b"I", b"Q")},
            },
    ...
    r(b"NSObject", b"hash", {"required": True, "retval": {"type": sel32or64(b"I", b"Q")}})
    r(
        b"NSObject",
    ...
    r(
        ...
        {
            "retval": {"type": "v"},
            "arguments": {2: {"type": sel32or64(b"I", b"Q")}, 3: {"type": b"@"}},
        },
    )
    r(
        b"NSObject",
    ...
    r(
        b"NSObject",
        b"setVersion:",
        {"retval": {"type": "v"}, "arguments": {2: {"type": sel32or64(b"i", b"q")}}},
    )
    r(
        b"NSObject",
    ...
    r(
        ...
        b"spellServer:checkString:offset:types:options:orthography:wordCount:",
        {
            ...
            "arguments": {
                ...
                6: {"type": b"@"},
                7: {"type": b"@"},
                8: {"type": sel32or64(b"^i", b"^q"), "type_modifier": b"o"},
            },
        },
    )
    r(
    ...
    r(
        ...
        b"spellServer:findMisspelledWordInString:language:wordCount:countOnly:",
        {
            ...
            "arguments": {
                ...
                3: {"type": b"@"},
                4: {"type": b"@"},
                5: {"type": sel32or64(b"^i", b"^q"), "type_modifier": b"o"},
                6: {"type": "Z"},
            },
        },
    )
    ...
    r(b"NSOrderedSet", b"orderedSetWithSet:copyItems:", {"arguments": {3: {"type": "Z"}}})
    r(
        b"NSOrderedSet",
        b"sortedArrayUsingComparator:",
        {
    ...
    r(
        ...
        b"isOperatingSystemAtLeastVersion:",
        {
            ...
            "arguments": {
                2: {
                    "type": sel32or64(
                        b"{_NSOperatingSystemVersion=iii}",
                        b"{_NSOperatingSystemVersion=qqq}",
                    )
                }
            },
        },
    ...
    r(
        ...
        b"getBytes:maxLength:usedLength:encoding:options:range:remainingRange:",
        {
            "retval": {"type": "Z"},
            "arguments": {
                2: {"type": "^v", "type_modifier": b"o", "c_array_length_in_arg": (3, 4)},
                4: {"type": sel32or64(b"^I", b"^Q"), "type_modifier": b"o"},
                7: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
                8: {
                    "type": sel32or64(b"^{_NSRange=II}", b"^{_NSRange=QQ}"),
                    "type_modifier": b"o",
                },
    ...
    r(
        ...
        {
            "arguments": {
                3: {"type": sel32or64(b"r^I", b"r^Q"), "type_modifier": b"o"},
                4: {"type_modifier": b"o"},
            }
        },
    )
    ...
    r(
        ...
        {
            "arguments": {3: {"type": sel32or64(b"*", b"[1{?=II^v^v}]")}},
    ...
    r(b"NSString", b"localizedCaseInsensitiveContainsString:", {"retval": {"type": b"Z"}})
    ...
    r(b"NSTask", b"launchAndReturnError:", {"retval": {"type": b"Z"}})
    r(
        b"NSTask",
    ...
    r(
        ...
        {
            "arguments": {
                2: {"c_array_delimited_by_null": True, "type_modifier": b"n"},
                3: {"type": "Z"},
            }
        },
    )
    ...
    r(b"NSURL", b"getPromisedItemResourceValue:forKey:error:", {"retval": {"type": b"Z"}})
    r(
        b"NSURL",
    ...
    r(b"NSURLDownload", b"setDeletesFileUponFailure:", {"arguments": {2: {"type": "Z"}}})
    r(
        b"NSURLDownload",
    ...
    r(b"NSURLProtocol", b"requestIsCacheEquivalent:toRequest:", {"retval": {"type": "Z"}})
    ...
    r(b"NSURLSessionTaskTransactionMetrics", b"isConstrained", {"retval": {"type": b"Z"}})
    ...
    r(b"NSUUID", b"getUUIDBytes:", {"arguments": {2: {"type_modifier": b"o"}}})
    r(b"NSUbiquitousKeyValueStore", b"boolForKey:", {"retval": {"type": "Z"}})
    r(b"NSUbiquitousKeyValueStore", b"setBool:forKey:", {"arguments": {2: {"type": "Z"}}})
    ...
    r(b"NSUserActivity", b"setEligibleForPrediction:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"NSUserActivity",
...
protocols = {
    "NSCoderMethods": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(None, b"version", sel32or64(b"i@:", b"q@:"), isRequired=False),
            objc.selector(
                None, b"setVersion:", sel32or64(b"v@:i", b"v@:q"), isRequired=False
            ),
            objc.selector(None, b"replacementObjectForCoder:", b"@@:@", isRequired=False),
    ...
    "NSCopyLinkMoveHandler": objc.informal_protocol(
        ...
        [
            objc.selector(
                None, b"fileManager:shouldProceedAfterError:", b"Z@:@@", isRequired=False
            ),
            objc.selector(
    ...
    "NSScriptClassDescription": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"classCode", sel32or64(b"L@:", b"I@:"), isRequired=False
            ),
        ],
    ),
    ...
    "NSKeyValueCoding": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(None, b"setValue:forUndefinedKey:", b"v@:@@", isRequired=False),
            objc.selector(None, b"mutableSetValueForKeyPath:", b"@@:@", isRequired=False),
        ],
    ),
    ...
    "NSScriptKeyValueCoding": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"valueWithUniqueID:inPropertyWithKey:", b"@@:@@", isRequired=False
            ),
            objc.selector(
                None,
                b"insertValue:atIndex:inPropertyWithKey:",
    ...
    "NSFileManagerFileOperationAdditions": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"fileManager:shouldRemoveItemAtPath:", b"Z@:@@", isRequired=False
            ),
            objc.selector(
                None, b"fileManager:shouldRemoveItemAtURL:", b"Z@:@@", isRequired=False
            ),
            objc.selector(
                None,
                b"fileManager:shouldProceedAfterError:removingItemAtPath:",
    ...
    "NSURLDownloadDelegate": objc.informal_protocol(
        "NSURLDownloadDelegate",
        [
            objc.selector(None, b"downloadDidBegin:", b"v@:@", isRequired=False),
            objc.selector(
                None,
                b"download:willSendRequest:redirectResponse:",
                b"@@:@@@",
            ...
            objc.selector(
                None, b"downloadShouldUseCredentialStorage:", b"Z@:@", isRequired=False
            ),
            objc.selector(
                None, b"download:didReceiveResponse:", b"v@:@@", isRequired=False
            ),
            objc.selector(
                None,
                b"download:willResumeWithResponse:fromByte:",
            ...
            objc.selector(
                None, b"download:didReceiveDataOfLength:", b"v@:@I", isRequired=False
            ),
            objc.selector(
                None,
                b"download:shouldDecodeSourceDataOfMIMEType:",
            ...
            objc.selector(
                None, b"download:didCreateDestination:", b"v@:@@", isRequired=False
            ),
            objc.selector(None, b"downloadDidFinish:", b"v@:@", isRequired=False),
            objc.selector(
                None, b"download:didFailWithError:", b"v@:@@", isRequired=False
            ),
        ],
    ),
    ...
    "NSDeprecatedKeyValueCoding": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(None, b"takeValuesFromDictionary:", b"v@:@", isRequired=False),
            objc.selector(None, b"handleQueryWithUnboundKey:", b"@@:@", isRequired=False),
    ...
    "NSURLConnectionDelegate": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"connection:needNewBodyStream:", b"@@:@@", isRequired=False
            ),
            objc.selector(
                None,
                b"connection:canAuthenticateAgainstProtectionSpace:",
            ...
            objc.selector(
                None, b"connectionShouldUseCredentialStorage:", b"Z@:@", isRequired=False
            ),
            objc.selector(
                None, b"connection:didReceiveResponse:", b"v@:@@", isRequired=False
            ),
            objc.selector(
                None, b"connection:didReceiveData:", b"v@:@@", isRequired=False
            ),
            objc.selector(
                None,
                b"connection:didSendBodyData:totalBytesWritten:totalBytesExpectedToWrite:",
            ...
            objc.selector(
                None, b"connectionDidFinishLoading:", b"v@:@", isRequired=False
            ),
            objc.selector(
                None, b"connection:didFailWithError:", b"v@:@@", isRequired=False
            ),
            objc.selector(
                None, b"connection:willCacheResponse:", b"@@:@@", isRequired=False
            ),
        ],
    ),
    ...
    "NSKeyValueObserverRegistration": objc.informal_protocol(
        ...
        [
            objc.selector(
                None, b"removeObserver:forKeyPath:context:", b"v@:@@^v", isRequired=False
            ),
            objc.selector(
                None,
                b"addObserver:forKeyPath:options:context:",
                sel32or64(b"v@:@@I^v", b"v@:@@Q^v"),
                isRequired=False,
            ),
            objc.selector(
    ...
    "NSClassDescriptionPrimitives": objc.informal_protocol(
        ...
        [
            objc.selector(None, b"inverseForRelationshipKey:", b"@@:@", isRequired=False),
    ...
    "NSURLClient": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"URL:resourceDidFailLoadingWithReason:", b"v@:@@", isRequired=False
            ),
        ],
    ),
    "NSKeyValueObservingCustomization": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"keyPathsForValuesAffectingValueForKey:", b"@@:@", isRequired=False
            ),
            objc.selector(
                None, b"automaticallyNotifiesObserversForKey:", b"Z@:@", isRequired=False
            ),
        ],
    ),
